    ...
    <div className="absolute inset-x-0 top-0 z-50 bg-transparent">
      ...
      >
        ...
        <div className="hidden sm:flex items-center justify-center gap-2">
          <NavPill href="/" currentPath={pathname}>Home</NavPill>
          <NavPill href="/chat" currentPath={pathname}>Chat</NavPill>
          <NavPill href="/journal" currentPath={pathname}>Journal</NavPill>
          <NavPill href="/todo" currentPath={pathname}>To-Do</NavPill>
          <NavPill href="/reminders" currentPath={pathname}>Reminders</NavPill>
          <NavPill href="/fix-it" currentPath={pathname}>Fix-It</NavPill>
          <NavPill href="/core" currentPath={pathname}>Core</NavPill>
          <NavPill href="/about" currentPath={pathname}>About</NavPill>
        </div>
        ...
        <div className="flex items-center justify-end gap-3">
          ...
          {!session ? (
            ...
            <>
              <NavPill href="/settings" currentPath={pathname}>Settings</NavPill>
              <button
                onClick={() => signOut()}
                className={cx(
