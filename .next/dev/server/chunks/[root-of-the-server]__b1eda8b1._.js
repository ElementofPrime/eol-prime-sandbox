...
"[project]/src/app/api/to-do/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    try {
        ...
        const items = await db.collection("todo_items").find({
...
async function POST(request) {
    ...
    try {
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongo$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clientPromise"];
        const db = client.db("eol_prime_dev");
        const maxOrder = await db.collection("todo_items").find({
            userId: session.user.id
        }).sort({
            order: -1
        }).limit(1).toArray();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b1eda8b1._.js.map